...
print("Punkt średniej szerokości:", MidLatitudePoint(phiA, phiB, phiC, phiD, lamA, lamB, lamC, lamD))
print("Azymuty AD:", Vincent(lamD, phiD,lamA,phiA))
print("Współrzedne punktu środkowego:", B, L)
print("Odległość między punktem śr. i śr. szerokości i azymuty:", Vincent(L, B, midLam, midPhi))
